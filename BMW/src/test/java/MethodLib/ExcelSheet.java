...
public class ExcelSheet {
	...
	****************************************************/
    ...
    public static void XL(WebDriver driver) throws IOException, RowsExceededException, WriteException {
		FileReader fr2=new FileReader("C:/Users/Ramakrishna/eclipse-workspace/BMW/src/test/java/Objrep/obj.properties");
		Properties obje=new Properties();
		obje.load(fr2);
		String speed= driver.findElement(By.xpath(obje.getProperty("speed"))).getText();
		System.out.println(speed);
		String EXCEL_FILE_LOCATION ="//C://Users//Ramakrishna//eclipse-workspace//BMW//src//test//java//FileUtillities//bmw.xls";
