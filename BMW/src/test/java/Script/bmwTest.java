...
Function Lib Name and path: MethodLib (Path:)
...
public class bmwTest {
  public void bmwrun() throws IOException, InterruptedException, RowsExceededException, WriteException {
	  ...
	  System.setProperty("webdriver.gecko.driver", "C:./driver/geckodriver.exe");
	   ...
	   FileReader fr2=new FileReader("C:\\Users\\Ramakrishna\\git\\BMW\\BMW\\src\\test\\java\\Objrep\\obj.properties");
	   ...
	   File scrsh1 = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(scrsh1,new File("C:\\Users\\Ramakrishna\\eclipse-workspace\\BMW\\src\\test\\java\\FileUtillities\\Screenshot1.png"));
		
		Seven.Seven(driver).click();
	   File scrsh2 = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(scrsh2,new File("C:\\Users\\Ramakrishna\\eclipse-workspace\\BMW\\src\\test\\java\\FileUtillities\\Screenshot2.png"));
		
		
		
		Imageclk.img(driver).click();
	   File scrsh4 = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(scrsh4,new File("C:\\Users\\Ramakrishna\\eclipse-workspace\\BMW\\src\\test\\java\\FileUtillities\\Screenshot4.png"));
		
		Technical.Technical(driver).click();
	   File scrsh5 = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(scrsh5,new File("C:\\Users\\Ramakrishna\\eclipse-workspace\\BMW\\src\\test\\java\\FileUtillities\\Screenshot5.png"));
